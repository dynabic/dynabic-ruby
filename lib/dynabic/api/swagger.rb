...
require_relative 'swagger/configuration'
require_relative 'swagger/request'
require_relative 'swagger/response'
require_relative 'swagger/version'
require 'logger'
...
module Swagger
  ...
  class << self
    ...
    #     config.client_id = '1234567890abcdef'     # required
    #     config.private_key = 'd9fysd7fysd9fho'     # required
